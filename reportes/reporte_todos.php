<?php
    ...
    */
    ...
    $pdf->Cell(0,4,utf8_decode('REPORTE TODAS LAS PERSONAS ATENDIDAS'),0,1,'C',0);//
    $pdf->Ln(5);
    ...
    $pdf->Cell(80,3,utf8_decode("Dirección"),1,0,'L',0);//
    ...
    while ($row2 = mysqli_fetch_assoc($query2)) {
        ...
        /*$pdf->Cell(7,3,utf8_decode("MG"),1,0,'C',0);//
        $pdf->Cell(7,3,utf8_decode("MG"),1,0,'C',0);//
        $pdf->Cell(7,3,utf8_decode("MG"),1,0,'C',0);//
        $pdf->Cell(7,3,utf8_decode("MG"),1,0,'C',0);//
        $pdf->Cell(7,3,utf8_decode("MG"),1,0,'C',0);//
    ...
    $pdf->Cell(30,3,utf8_decode("."),1,1,'L',0);//
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    while ($row = mysqli_fetch_array($query)){
        ...
        $pdf->Cell(80,3,utf8_decode($direccion),1,0,'L',0);//
